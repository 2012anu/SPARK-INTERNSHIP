...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        ...
        <a class="navbar-brand" href="#">Fellowman Bank <img src="logo/logo.webp" alt="Bank" width="50" height="50"></a>
...
<class class="welcome">
        <h2>
            <img src="fm.jpeg" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History</strong> <img
                src="fm.jpeg" alt="Bank" width="75" height="75">
        </h2>
    </class>
    ...
    <div class="foot">
        <footer class="bg-light text-center text-lg-start">
            ...
            <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
                © 2021 Copyright - Made with 🧡 by Sumit Vajarinkar :
